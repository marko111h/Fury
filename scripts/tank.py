...
class Tank:
    def __init__(self, id, curr_position, spawn_position, capture_points, speed_points, hit_points, fire_power, destruction_points, owner, prev_attacker, order_position):
        self.id = id
